...
defaultTimeoutInterval = process.env.DEBUG ? 60 * 60 * 500 : 60000;
...
exports.config = {
  ...
  // Patterns to exclude.
  exclude: [
    // 'features/InflowOutfllowRegistration.feature',
    // './features/BasicReportCheck.feature',
    // './features/UpdateCancelDelete.feature'
  ],
  //
  // ============
  // Capabilities
